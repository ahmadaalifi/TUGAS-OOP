public class Main {
    public static void main(String[] args) {
        ...
        pegawai01.NamaCust = "Asep";
        pegawai01.namaPegawai = "Udin";
        pegawai01.Harga = "45.000";
        pegawai01.Member = "012";
        pegawai01.caraBayar = "QRIS";
        pegawai01.jenisMobil = "SUV";

        System.out.println("Customer " + pegawai01.NamaCust + " dikerjakan oleh Pegawai: " + pegawai01.namaPegawai);
        System.out.print("Pegawai " + pegawai01.namaPegawai + " Bekerja pada ");pegawai01.jadwalShift();
        System.out.println();
